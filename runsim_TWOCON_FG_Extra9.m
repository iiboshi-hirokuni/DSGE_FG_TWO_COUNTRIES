...
constraint1      = ['(r_h_difference     < istar) | (r_not_lag1_h_difference  < istar)',...
                    ...
                    ' | (r_not_lag8_h_difference  < istar) | (r_not_lag9_h_difference  < istar)',...                   
                      ]; % effective lower bound on the nominal interest rates
...
[loss_FG_9, loss_FG_9_h, loss_FG_9_f ] = func_cal_walfare(P,pi_h_piecewise,pi_f_piecewise,x_h_piecewise,x_f_piecewise,r_h_piecewise,r_f_piecewise );

save('./cal_results/loss_FG_9.mat', 'loss_FG_9', 'loss_FG_9_h','loss_FG_9_f');
% load('loss_zlb.mat');
% 
% 
% ti = linspace(0,12,13);
...
%%
 save ./cal_results/IRF_FG_9 line1_fg;
 ...
 figtitle = '';
 figlabel= '';
 legendlist = cellstr(char('FG  9Q Extra','ZLB'));
