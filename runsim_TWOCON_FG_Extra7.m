...
[loss_FG_7, loss_FG_7_h, loss_FG_7_f ] = func_cal_walfare(P,pi_h_piecewise,pi_f_piecewise,x_h_piecewise,x_f_piecewise,r_h_piecewise,r_f_piecewise );

save('./cal_results/loss_FG_7.mat', 'loss_FG_7', 'loss_FG_7_h','loss_FG_7_f');
% load('loss_zlb.mat');
% 
% 
% ti = linspace(0,12,13);
...
%%
 save ./cal_results/IRF_FG_7 line1_fg;
